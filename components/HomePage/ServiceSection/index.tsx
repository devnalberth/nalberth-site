...
const services: Service[] = [
    {
        title: "Design",
        numbering: "01",
        listItems: ["UI/UX", "Figma", "Prototipagem", "Arquitetura da página", "Otimização"],
    },
    {
        title: "Estratégia",
        numbering: "02",
        listItems: ["Briefing", "Análise de público", "Copy de conversão", "Social Media", "Estratégia de Conteúdo"],
    },
    {
        title: "Desenvolvimento",
        numbering: "03",
        listItems: ["Frontend", "React", "Next.js", "Integração de APIs", "Deploy"],
    },
    {
        title: "E-commerce",
        numbering: "04",
        listItems: ["Shopify", "Nuvemshop", "WooCommerce", "Estrutura de loja", "Checkout"],
    },
];
    ...
    return (
        <section className={styles.services} id="servicos">
            ...
            <div className={styles.heading}>
                <div ref={taglineRef}>
                    <Tag text='Capacidades' />
                </div>
                <div className={styles.headingWrapper}>
                    <h1 ref={headingRef}>
                        {splitText("Soluções sob medida para a sua visão")}
                    </h1>
