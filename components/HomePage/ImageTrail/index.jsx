        ...
        class ImageTrailEffect {
            ...
            layout() {
                ...
                this.DOM.el.innerHTML = Array.from({ length: this.totalTrailElements }, (_, i) => {
                    ...
                    return `<img class="trail__img" src="${bgImage}" alt="" aria-hidden="true" style="opacity: ${opacityVal}"/>`;
                }).join('');
    ...
    return (
        <>
            <div className={styles.content}>
                <div ref={trailRef} className={styles.trail} style={{ backgroundImage: 'url(/images/imagehero.webp)' }} />
            </div>
        </>
    );
}
